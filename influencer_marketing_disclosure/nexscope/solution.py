...
SKILL.md (sitting next to this script, nexscope-ai/eCommerce-Skills'
tiktok-influencer-marketing skill) and applies it via a direct Anthropic
API call.

This skill is fully self-contained in one SKILL.md, so the whole file is
bundled and used as-is.
"""
